...
def setup_collectd(perf_data):
    ...
    id_pub = subprocess.Popen("ssh-keygen -y -f /var/lib/jenkins/workspace/perf-test-downstream-57z-test-idle/id_rsa_t", shell=True, stdout=subprocess.PIPE).stdout.read()
